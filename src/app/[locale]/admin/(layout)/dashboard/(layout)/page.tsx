import {BaseButton, Icon, ManagersCard} from "@/shared";
    ...
    return (
        <div className={sx.dashboardPage}>
            <div className={sx.topWrap}>
                <h2>Employees</h2>
                <BaseButton active={true} icon={<Icon.Copy/>} text={'Create employee'}/>
            </div>
            <div className={sx.bottomWrap}>
                <ManagersCard image={raxbar} name={'MAMASIDIKOV MUXSINJON MUSAJONOVICH'}
