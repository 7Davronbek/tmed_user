...
export const NewsSingleCard: FC<NewsProps> = ({ item, locale }) => {
  ...
  return <div className={sx.card}></div>;
};
...
//               height={0}
//               src={
//                 "https://dwed.fra1.digitaloceanspaces.com/UMS/media/Avatar/image/73fe801a-435f-44cb-b619-2f5b15ab1b5f"
//               }
//               alt={"Avatar"}
//             />
//           ) : (
...
//                 <Image width={110} height={110} src={img} alt={"Media"} />{" "}
//               </SwiperSlide>
//             ))}
//         </Swiper>
//       </div>
